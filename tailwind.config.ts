...
import defaultTheme from 'tailwindcss/defaultTheme'; // Importera standardtemat
...
    },
    extend: {
      // --- NYTT: Lägg till anpassade typsnitt ---
      fontFamily: {
        // Lägg till Nunito i din font-familj, med fallback till sans-serif
        nunito: ['Nunito', ...defaultTheme.fontFamily.sans],
      },
      // --- NYTT: Lägg till logotypfärgen ---
      colors: {
        // Din mörkblågrå ton: hsl(215, 27.19%, 30.83%)
        'logo-dark': 'hsl(215, 27.19%, 30.83%)',
