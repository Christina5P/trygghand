...
dotenv.config({ path: "../../libs/shared/.env" }); // ladda rätt .env innan andra imports
...
console.log('SUPABASE_URL=', process.env.SUPABASE_URL ? 'OK' : 'MISSING', 'SERVICE_ROLE=', !!process.env.SUPABASE_SERVICE_ROLE_KEY);
