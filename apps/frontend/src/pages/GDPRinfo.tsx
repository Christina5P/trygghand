export default function GDPRinfo() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      ...
      <p className="mb-2">
        Trygg Partner är personuppgiftsansvarig. För frågor: <a href="mailto:info@dindoman.example" className="underline">info@dindoman.example</a>
      </p>
