...
serve(async (req: Request): Promise<Response> => {
  ...
  const baseSelect =
    "id, customer_id, subscription_id, provider, service_type, custom_service_name, notice_period, last_due_date, provider_contact, notes, status, documents, admin_notes, admin_last_read_at, customer_last_read_at, created_at, updated_at";
