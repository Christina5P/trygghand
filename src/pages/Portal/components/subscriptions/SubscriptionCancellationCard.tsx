      ...
      <CardHeader className="pb-3 flex justify-between items-start gap-3">
        ...
        <div className="flex items-center gap-2" onClick={e => e.stopPropagation()}>
          ...
          <button
            ...
            className="p-1 h-7 w-7 text-gray-400 hover:text-red-600 hover:bg-red-50 border border-gray-200 rounded"
            style={{ minWidth: 28, minHeight: 28 }}
            onClick={async (e) => {
              e.stopPropagation();
              if (!window.confirm("Är du säker på att du vill ta bort detta abonnemang?")) return;
              // TODO: Implementera delete-funktion via prop eller context
            }}
          >
