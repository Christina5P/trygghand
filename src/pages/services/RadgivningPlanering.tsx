...
import { Users, ArrowLeft, CheckCircle, MessageSquare, Clock, UserCheck } from "lucide-react";
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="w-8 h-8 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-1">1</div>
                  <div>
                    <h4 className="font-medium text-foreground">Första konsultationen</h4>
                    <p className="text-muted-foreground text-sm">Vi träffas för att förstå dina behov och situation</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-8 h-8 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-1">2</div>
                  <div>
                    <h4 className="font-medium text-foreground">Planering</h4>
                    <p className="text-muted-foreground text-sm">Vi skapar en detaljerad plan anpassad efter dina behov</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-8 h-8 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-1">3</div>
                  <div>
                    <h4 className="font-medium text-foreground">Genomförande</h4>
                    <p className="text-muted-foreground text-sm">Vi följer planen med regelbundna uppdateringar</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-8 h-8 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-1">4</div>
                  <div>
                    <h4 className="font-medium text-foreground">Uppföljning</h4>
                    <p className="text-muted-foreground text-sm">Vi säkerställer att allt genomförts enligt plan</p>
                  </div>
                </div>
              </div>
            </CardContent>
