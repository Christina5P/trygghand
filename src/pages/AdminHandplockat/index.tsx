...
export default function AdminHandplockat() {
  ...
  if (loading || (user && isAdmin === null)) return <div className="p-8 text-center">Laddar...</div>;
  ...
  if (!isAdmin) return <div className="p-8 text-center text-red-600">Ej behörig</div>;
