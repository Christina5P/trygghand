      ...
      <div className="max-w-5xl mx-auto px-4 py-6 flex items-center justify-between gap-2 md:gap-6">
        ...
        <div className="flex-1 flex justify-center">
          <span className="inline-flex items-center gap-1 text-muted-foreground text-sm">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-recycle w-4 h-4">
        ...
        <div className="flex flex-col md:items-end text-xs text-muted-foreground gap-1 justify-end">
          ...
          <span>
            Betalning via Swish efter bekräftelse · Ingen betalning sker direkt
          </span>

          <Link
            to="/handplockat-terms"
